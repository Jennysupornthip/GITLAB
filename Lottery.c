...
void main()
{
  int WinLotteryNo[10] = {2222, 1711, 5515, 7233, 5614, 8876, 1215, 4232, 9155, 9995};
<<<<<<< HEAD
  float WinAmount[10] = {66666, 10000, 10000, 5000, 5000, 5000, 5000, 3000, 3000, 3000};
  int N = 50;
=======
  float WinAmount[10] = {55555, 10000, 10000, 5000, 5000, 5000, 5000, 3000, 3000, 3000};
  int N = 20;
>>>>>>> 3b7c9516b18d3e735108f2e6827a2fa20df7b3cf
  int i, won;
